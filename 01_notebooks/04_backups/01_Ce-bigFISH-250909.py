...
run_2cell_classifier = os.getenv('RUN_2CELL_CLASSIFIER', 'True') == 'True'
run_4cell_classifier = os.getenv('RUN_4CELL_CLASSIFIER', 'True') == 'True'
...
# # # Note: input directory = image subdiorectory
# folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/01_quant-paper/02_N2_lin-41_set-3/230521_N2_lin-41_set-3_rep1/230521_N2_lin-41_set-3_rep1_4-cell/input/08'
...
### Cell sorting using DAPI channel
...
sns.barplot(data=features_df, x='highest_confidence_label', y='area')
plt.ylabel("Cell area (pixels)")
plt.title("Cell Areas by Predicted Label")
plt.show()
