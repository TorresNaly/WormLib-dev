...
# # # Note: input directory = image subdiorectory
# folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/02_DG_quantification/WDMP91_smFISH/250207_WDMP91/2-cell/Dark/input/06'

# # User-defined channel names (set to None if the channel does not exist)
# Cy5 = "set-3_mRNA"  # (Q670)
# mCherry = "lin-41_mRNA"  # (Q610)
# FITC = "SPN-4-balancer"  # (GFP)
# DAPI = "DAPI"
