...
def run_embryo_segmentation(bf, image_nuclei, image_name, output_directory):
...
if run_embryo_segmentation:
    masks_cytosol, masks_nuclei, masks_cyto_sizes, masks_nuc_sizes = run_embryo_segmentation(
