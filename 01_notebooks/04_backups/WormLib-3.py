...
# 1. Define image path, microscope parameters and channel names (set to None if the channel does not exist)
folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/01_quant-paper/01_N2_erm-1_set-3/240628_N2_erm-1_set-3/2-cell/input/01' #image subdirectory path
