...
embryo_diameter = os.getenv('EMBRYO_DIAMETER', '500') == '500'
...
# # # Note: input directory = image subdiorectory
# folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/01_quant-paper/01_N2_erm-1_set-3/240628_N2_erm-1_set-3/2-cell/input/12'
...
#     # Run threshold-based segmentation for nuclei
#     masks_nuclei, mask_sizes_nuc = nuclear_segmentation(nuclei_image)
