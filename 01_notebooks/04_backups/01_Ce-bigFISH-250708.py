...
if any(x is not None for x in [sum_spots_ch0, sum_spots_ch1]):
    ...
    labeled_array = label(masks_nuclei)
    num_features = labeled_array.max()  # count of labeled regions
...
#     def create_heatmap(spots_x, spots_y, masks_cytosol, masks_nuclei, output_filename, title_suffix,
...
#         # Standard heatmap
#         plt.imshow(masks_cytosol, cmap='gray')
#         plt.imshow(masks_nuclei, cmap='gray')
#         plt.imshow(grid, cmap='CMRmap', alpha=1, interpolation='nearest')
...
#         # Side-by-side display of rna_max + heatmap
...
#             axs[1].imshow(grid, cmap='CMRmap', interpolation='nearest')
#             axs[1].set_title(f"{title_suffix} heatmap")
#             axs[1].axis("off")

#             plt.tight_layout()
#             combined_path = os.path.join(output_directory, f"{title_suffix}_heatmap_combined.png")
...
#             os.path.join(output_directory, f'{Cy5}_heatmap.png'),
#             title_suffix=Cy5,
#             rna_max=image_Cy5,
...
#             os.path.join(output_directory, f'{mCherry}_heatmap.png'),
...
import time
time.sleep(2)  # brief pause before reading log
