...
# # # Note: input directory = image subdiorectory
# folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/01_quant-paper/01_N2_erm-1_set-3/240812_N2_erm-1_set-3/2-cell/input/12'
...
def nuclear_segmentation(image_nuclei):
    """
    Segment nuclei using Cellpose instead of manual thresholding.
    Returns:
        masks_nuclei : labeled nuclei mask (same as old function)
    """
