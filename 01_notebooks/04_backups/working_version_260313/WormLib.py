...
# # 1. Define image path, microscope parameters and channel names (set to None if the channel does not exist)
# folder_name = '/pl/active/onishimura_lab/PROJECTS/naly/bigfish/01_erm-1_paper/02_RNAi_quantification/LP306_membrane/L4440_RNAi/230828_L4440_RNAi_rep1/input/04' #image subdirectory path
